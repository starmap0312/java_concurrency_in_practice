...
//    concurrent applications can be decomposed into a number of simpler, synchronous workflows each running in a separate thread,
...
//    long-running task is instead executed in a separate thread, the event thread remains free to process UI events,
//      this makes the UI more responsive
//    we don't need to frequently poll for input events if using multi-threading
